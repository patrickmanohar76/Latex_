...
int main(void)
{
    ...
    PyHal_GPIO_SetDir(16,1);
    PyHal_GPIO_SetDir(13,1);
    PyHal_GPIO_SetDir(18,0);
    PyHal_GPIO_SetDir(19,0);
    PyHal_GPIO_SetDir(20,0);

    while(1){
	    PyHal_GPIO_Set(13,1);
	    HAL_DelayUSec(1000000);
	    Q0=PyHal_GPIO_Get(18);
	    Q1=PyHal_GPIO_Get(19);
	    Q2=PyHal_GPIO_Get(20);
	    D2=(Q2&&!Q0)||(Q0&&!Q2);
	    D1=Q2;
	    D0=Q1;
	    PyHal_GPIO_Set(14,D0);
	    PyHal_GPIO_Set(15,D1);
	    PyHal_GPIO_Set(16,D2);
	    PyHal_GPIO_Set(13,0);
    }
